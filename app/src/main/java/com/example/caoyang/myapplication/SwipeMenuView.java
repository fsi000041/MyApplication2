...
public class SwipeMenuView extends ViewGroup {
     ...
     * 菜单展开时，是否拦截上下滑动事件
     */
    private boolean upDownSwipeIntercept;
    ...
    public void setUpDownSwipeIntercept(boolean upDownSwipeIntercept) {
        this.upDownSwipeIntercept = upDownSwipeIntercept;
    }
